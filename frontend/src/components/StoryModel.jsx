        ...
        justify-center p-4'>
            <div className='w-full max-w-md'>
                ...
                <div className='flex gap-2 mt-4'>
                    <button onClick={() => { setMode('text'); setMedia(null); setPreviewUrl(null) }} className={`flex-1 flex items-center justify-center cursor-pointer gap-2 p-2 rounded
                ...
                className='flex items-center justify-center gap-2 py-3 mt-4 rounded bg-linear-to-r w-full
                 from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-indigo-700 active:scale-95
